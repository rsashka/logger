...
#define LOG_EXCEPT(EXCEPT_TYPE, ...)  throw EXCEPT_TYPE(std::string(LOG_MAKE(LOG_LEVEL_ERROR, "E:",__VA_ARGS__)))
#define LOG_RUNTIME(...)  LOG_PRINT_CALLSTACK(); LOG_EXCEPT(std::runtime_error, __VA_ARGS__)
...
#define LOG_PRINT_CALLSTACK() log_print_callstack()
#endif
